...
def build_runtime(restaurant_id: str = "demo") -> AppRuntime:
    ...
    intent_model_dir = _get_env_path("COMPASS_INTENT_MODEL_DIR", "app/ml/models/distilbert-multihead-intent")
    ...
    slot_model_dir = _get_env_path("COMPASS_SLOT_MODEL_DIR", "app/ml/models/spacy_slot_trf_out/model-best")
